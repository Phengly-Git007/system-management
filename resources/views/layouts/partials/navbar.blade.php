<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../index3.html" class="nav-link @lang('app.kh')">@lang('app.home')</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link @lang('app.kh')">@lang('app.contact')</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          <img src="{{ asset('template/dist/flag')}}/{{ app()->getLocale()}}.png" alt="{{ app()->getLocale() }}" style="height:1.3rem; top:-2px;position:relative" >
          <span class="badge badge-secondary navbar-badge">{{ app()->getLocale() }}</span>
        </a>
        <form action="{{ route('locale') }}" method="POST" class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            @csrf
            ...
            <button type="submit" name="en" value="en" class="dropdown-item">
               <img src="{{ asset('template/dist/flag/en.png') }}" alt="en" class="mr-2" style="height:1.3rem; top:-2px;position:relative" >
            english
                <span class="float-right text-muted text-sm">English</span>
            </button>
            <div class="dropdown-divider"></div>
            <button type="submit" name="kh" value="kh"  class="dropdown-item">
               <img src="{{ asset('template/dist/flag/kh.png') }}" alt="en" class="mr-2" style="height:1.3rem; top:-2px;position:relative" >
               khmer
